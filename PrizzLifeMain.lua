--[[ PrizzLife V1.1 Main ReWrite, made by Nivalos, influenced by Vlaair.
...
Update Log 3:
Fixed "Criminal" button in TeamGui selector
...
Update Log 1:
Fixed all instances of "TeamTo()"
Removed anything featuring TeamColor
--]]
...
local function ChangeTeam(TeamName, Switch)
    ...
    elseif TeamName == "Criminals" then
        ...
        elseif player.Team == "Neutral" then
            TeamEve("Inmates")
            local char = player.CharacterAdded:Wait() -- Wait for respawn
            char.HumanoidRootPart.CFrame = CFrame.new(-974.720, 108.324, 2058.452)
