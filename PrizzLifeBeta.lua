--[[ PrizzLife V1 ReWrite, made by Nivalos, influenced by Vlaair.
...
local function ChangeTeam(TeamName, Switch)
    ...
    elseif TeamName == "Criminals" then
        ...
        TeamEve("Neutral")
        task.wait(4)
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-974.720, 108.324, 2058.452)
