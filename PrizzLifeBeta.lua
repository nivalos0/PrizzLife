...
-- Your trying to skid this, aren't you?
			...
			task.spawn(function()
				while States.AutoGuard do task.wait()
					if LocalPlayer.TeamColor.Name ~= "Bright blue" then
						...
						else Notif("Error", "Guards team full, autoguards halted."); break
						end
					end
...
--]]
	...
	if Execution_Runtime then
		Notif("Potang Ina Mo", "Updated as of 2/8/26", 6)
...
if executor == "Solara" then
    ...
    LocPL.ShittyExecutor = true
      ...
      --print("Good boy for not using Solara.")
end
