--[[ PrizzLife V1.5 Beta ReWrite, made by Nivalos, influenced by Vlaair.
...
local ItemLocations = {
    -- Riot Gamepass
    Shield = CFrame.new(847.197, 99.977, 2231.329);
}
...
local function GiveGun(itemname)
	...
	elseif itemname == "RemingtonCrim" then
		...
		task.wait(0.2)
		ItemEvent:InvokeServer(workspace.Prison_ITEMS.giver:GetChildren()[4]["Meshes/r870_2"])
