--[[ PrizzLife V1.6 Beta ReWrite, made by Nivalos, influenced by Vlaair.
...
local OnCommand = function(text)
	...
	elseif cm("revolver") or cm("pistol") then
			GiveGun("Revolver")
    elseif cm("c4") or cm("explosive") or cm("boom") then
			GiveGun("MafiaC4")
...
task.spawn(function()
	...
	AddList("c4 / explosive / boom", "Obtain the C4 Bomb (REQUIRES GAMEPASS)", false) --V
